...
const Hero = () => {
    return (
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-5 ml-24 ' >
                ...
                <div className='w-[360px] h-[306px] bg-slate-200'>
                    <div className='flex justify-center items-center mt-9'><Image src={'/chair14.png'} height={229} width={223} alt='chair12' /></div>
                    <div className='flex justify-around items-end'>
                        <p>Comfort HandyCraft</p>
                        <div className='flex gap-3'>
                            <p>$41.00</p>
                ...
                <div className='w-[360px] h-[306px] bg-slate-200'>
                    <div className='flex justify-center items-center mt-9'><Image src={'/image17.png'} height={229} width={223} alt='chair12' /></div>
                    <div className='flex justify-around items-end'>
                        <p>Comfort HandyCraft</p>
                        <div className='flex gap-3'>
                            <p>$41.00</p>
    ...
    <div className='flex justify-center items-center mt-5 mb-5'><Image src={'/brands.png'} height={93} width={904} alt='brands'/></div>
