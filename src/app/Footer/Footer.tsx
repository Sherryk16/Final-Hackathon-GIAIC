    ...
    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a href='/Pages/ShopList' className="text-gray-600 hover:text-gray-800">Browse the Shop</a>
          </li>
          <li>
            <a href='/Pages' className="text-gray-600 hover:text-gray-800">Category</a>
          </li>
          <li>
